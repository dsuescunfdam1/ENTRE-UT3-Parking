...
public class Parking
{
    ...
    if(minutosAparcados < 180){
        ...
        tipoDeTarifa += "Comercial de las primeras 3 horas más media comercial";
    }
    comercial ++;
    break;
  }
    ...
    System.out.println("************************************");
    System.out.println("Nº de Cliente:" + cliente);
    ...
    public void printEstadísticas() {
        ...
        System.out.println("Nº de clientes tarifa comercial:" + comercial);
        System.out.println("Cliente tarifa COMERCIAL con factura maxima fue el nº 2" + 
